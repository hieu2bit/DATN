...
export default function Color() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-2xl font-bold mb-4">Quản lý loại màu sắc</h1>
      <div className="flex items-center justify-between mb-4">
        <input
          type="text"
          placeholder="Tìm kiếm loại màu sắc"
          ...
          {colors.map((item, index) => (
            <tr key={item.id} className="bg-white text-black hover:bg-gray-50 text-xs">
              ...
              <td className="px-4 py-2 flex justify-center gap-4">
                <button className="text-blue-500 hover:text-blue-700 p-1 rounded-full hover:bg-blue-100 transition-colors" onClick={() => handleUpdateColor(item)}>
      ...
      <div className="flex items-center justify-between mt-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm">loại màu sắc</span>
        </div>
        <div className="flex items-center gap-2">
